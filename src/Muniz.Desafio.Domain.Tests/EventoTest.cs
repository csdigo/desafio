...
namespace Muniz.Domain.Test
{
    ...
    public class EventoTest
    {
        ...
        {
            var evento = new Evento("brasil.sudeste.sensor01", "abc", DateTime.Now.Ticks);
        ...
        {
            var evento = new Evento("brasil.sudeste.sensor01", "", DateTime.Now.Ticks);
        ...
        {
            var evento = new Evento("brasil.sudeste.sensor01", "tudo certo", DateTime.Now.Ticks);
        ...
        {
            var evento = new Evento("brasil.sudeste.sensor01", "1", DateTime.Now.Ticks);
